...
export async function getFlights(
  options: { bbox?: BBox; limit?: number } = {},
): Promise<FlightFeed> {
      ...
      const flights = (raw.states ?? [])
        .map((state) => {
          ...
          return {
            ...
            callsign:
              typeof state[S.Callsign] === 'string' ? state[S.Callsign].trim() || null : null,
            ...
            lastContact: new Date(
              (numberOrNull(state[S.LastContact]) ?? raw.time) * 1000,
            ).toISOString(),
...
export const MAJOR_AIRPORTS: readonly Airport[] = [
  {
    ...
    city: 'Atlanta',
    countryCode: 'US',
    location: { lng: -84.4277, lat: 33.6407 },
    elevationM: 313,
    timezone: 'America/New_York',
    passengers: 104_653_000,
  },
  {
    iata: 'DXB',
    icao: 'OMDB',
    ...
    city: 'Dubai',
    countryCode: 'AE',
    location: { lng: 55.3644, lat: 25.2532 },
    elevationM: 19,
    timezone: 'Asia/Dubai',
    passengers: 86_994_000,
  },
  {
    iata: 'DFW',
    icao: 'KDFW',
    ...
    city: 'Dallas',
    countryCode: 'US',
    location: { lng: -97.038, lat: 32.8998 },
    elevationM: 185,
    timezone: 'America/Chicago',
    passengers: 81_762_000,
  },
  {
    iata: 'HND',
    icao: 'RJTT',
    ...
    city: 'Tokyo',
    countryCode: 'JP',
    location: { lng: 139.7798, lat: 35.5494 },
    elevationM: 6,
    timezone: 'Asia/Tokyo',
    passengers: 78_700_000,
  },
  {
    iata: 'LHR',
    icao: 'EGLL',
    ...
    city: 'London',
    countryCode: 'GB',
    location: { lng: -0.4543, lat: 51.4706 },
    elevationM: 25,
    timezone: 'Europe/London',
    passengers: 79_200_000,
  },
  {
    iata: 'DEN',
    icao: 'KDEN',
    ...
    city: 'Denver',
    countryCode: 'US',
    location: { lng: -104.6737, lat: 39.8561 },
    elevationM: 1655,
    timezone: 'America/Denver',
    passengers: 77_800_000,
  },
  {
    iata: 'IST',
    icao: 'LTFM',
    ...
    city: 'Istanbul',
    countryCode: 'TR',
    location: { lng: 28.7519, lat: 41.2753 },
    elevationM: 99,
    timezone: 'Europe/Istanbul',
    passengers: 76_000_000,
  },
  {
    iata: 'LAX',
    icao: 'KLAX',
    ...
    city: 'Los Angeles',
    countryCode: 'US',
    location: { lng: -118.4085, lat: 33.9416 },
    elevationM: 38,
    timezone: 'America/Los_Angeles',
    passengers: 75_050_000,
  },
  {
    iata: 'ORD',
    icao: 'KORD',
    ...
    city: 'Chicago',
    countryCode: 'US',
    location: { lng: -87.9048, lat: 41.9786 },
    elevationM: 204,
    timezone: 'America/Chicago',
    passengers: 73_890_000,
  },
  {
    iata: 'CDG',
    icao: 'LFPG',
    ...
    city: 'Paris',
    countryCode: 'FR',
    location: { lng: 2.5479, lat: 49.0097 },
    elevationM: 119,
    timezone: 'Europe/Paris',
    passengers: 67_400_000,
  },
  {
    iata: 'DEL',
    icao: 'VIDP',
    ...
    city: 'Delhi',
    countryCode: 'IN',
    location: { lng: 77.1, lat: 28.5562 },
    elevationM: 237,
    timezone: 'Asia/Kolkata',
    passengers: 72_200_000,
  },
  {
    iata: 'AMS',
    icao: 'EHAM',
    ...
    city: 'Amsterdam',
    countryCode: 'NL',
    location: { lng: 4.7639, lat: 52.3086 },
    elevationM: -3,
    timezone: 'Europe/Amsterdam',
    passengers: 61_900_000,
  },
  {
    iata: 'SIN',
    icao: 'WSSS',
    ...
    city: 'Singapore',
    countryCode: 'SG',
    location: { lng: 103.9915, lat: 1.3644 },
    elevationM: 7,
    timezone: 'Asia/Singapore',
    passengers: 58_900_000,
  },
  {
    iata: 'CAN',
    icao: 'ZGGG',
    ...
    city: 'Guangzhou',
    countryCode: 'CN',
    location: { lng: 113.2988, lat: 23.3924 },
    elevationM: 15,
    timezone: 'Asia/Shanghai',
    passengers: 63_100_000,
  },
  {
    iata: 'PVG',
    icao: 'ZSPD',
    ...
    city: 'Shanghai',
    countryCode: 'CN',
    location: { lng: 121.8053, lat: 31.1443 },
    elevationM: 4,
    timezone: 'Asia/Shanghai',
    passengers: 54_400_000,
  },
  {
    iata: 'FRA',
    icao: 'EDDF',
    ...
    city: 'Frankfurt',
    countryCode: 'DE',
    location: { lng: 8.5622, lat: 50.0379 },
    elevationM: 111,
    timezone: 'Europe/Berlin',
    passengers: 59_400_000,
  },
  {
    iata: 'JFK',
    icao: 'KJFK',
    ...
    city: 'New York',
    countryCode: 'US',
    location: { lng: -73.7781, lat: 40.6413 },
    elevationM: 4,
    timezone: 'America/New_York',
    passengers: 62_500_000,
  },
  {
    iata: 'MAD',
    icao: 'LEMD',
    ...
    city: 'Madrid',
    countryCode: 'ES',
    location: { lng: -3.5676, lat: 40.4719 },
    elevationM: 610,
    timezone: 'Europe/Madrid',
    passengers: 60_200_000,
  },
  {
    iata: 'BCN',
    icao: 'LEBL',
    ...
    city: 'Barcelona',
    countryCode: 'ES',
    location: { lng: 2.0785, lat: 41.2974 },
    elevationM: 4,
    timezone: 'Europe/Madrid',
    passengers: 49_900_000,
  },
  {
    iata: 'ICN',
    icao: 'RKSI',
    ...
    city: 'Seoul',
    countryCode: 'KR',
    location: { lng: 126.4407, lat: 37.4602 },
    elevationM: 7,
    timezone: 'Asia/Seoul',
    passengers: 56_100_000,
  },
  {
    iata: 'MEX',
    icao: 'MMMX',
    ...
    city: 'Mexico City',
    countryCode: 'MX',
    location: { lng: -99.0721, lat: 19.4363 },
    elevationM: 2230,
    timezone: 'America/Mexico_City',
    passengers: 45_400_000,
  },
  {
    iata: 'GRU',
    icao: 'SBGR',
    ...
    city: 'São Paulo',
    countryCode: 'BR',
    location: { lng: -46.4731, lat: -23.4356 },
    elevationM: 750,
    timezone: 'America/Sao_Paulo',
    passengers: 41_600_000,
  },
  {
    iata: 'SYD',
    icao: 'YSSY',
    ...
    city: 'Sydney',
    countryCode: 'AU',
    location: { lng: 151.1772, lat: -33.9399 },
    elevationM: 6,
    timezone: 'Australia/Sydney',
    passengers: 38_400_000,
  },
  {
    iata: 'JNB',
    icao: 'FAOR',
    ...
    city: 'Johannesburg',
    countryCode: 'ZA',
    location: { lng: 28.2426, lat: -26.1367 },
    elevationM: 1694,
    timezone: 'Africa/Johannesburg',
    passengers: 21_200_000,
  },
  {
    iata: 'CAI',
    icao: 'HECA',
    ...
    city: 'Cairo',
    countryCode: 'EG',
    location: { lng: 31.4056, lat: 30.1219 },
    elevationM: 116,
    timezone: 'Africa/Cairo',
    passengers: 26_300_000,
  },
  {
    iata: 'DOH',
    icao: 'OTHH',
    ...
    city: 'Doha',
    countryCode: 'QA',
    location: { lng: 51.6081, lat: 25.2731 },
    elevationM: 4,
    timezone: 'Asia/Qatar',
    passengers: 52_700_000,
  },
  {
    iata: 'BOM',
    icao: 'VABB',
    ...
    city: 'Mumbai',
    countryCode: 'IN',
    location: { lng: 72.8679, lat: 19.0896 },
    elevationM: 11,
    timezone: 'Asia/Kolkata',
    passengers: 52_800_000,
  },
  {
    iata: 'YYZ',
    icao: 'CYYZ',
    ...
    city: 'Toronto',
    countryCode: 'CA',
    location: { lng: -79.6306, lat: 43.6777 },
    elevationM: 173,
    timezone: 'America/Toronto',
    passengers: 44_800_000,
  },
  {
    iata: 'SVO',
    icao: 'UUEE',
    ...
    city: 'Moscow',
    countryCode: 'RU',
    location: { lng: 37.4146, lat: 55.9726 },
    elevationM: 190,
    timezone: 'Europe/Moscow',
    passengers: 43_400_000,
  },
  {
    iata: 'BKK',
    icao: 'VTBS',
    ...
    city: 'Bangkok',
    countryCode: 'TH',
    location: { lng: 100.7501, lat: 13.6811 },
    elevationM: 2,
    timezone: 'Asia/Bangkok',
    passengers: 51_800_000,
  },
] as const;
